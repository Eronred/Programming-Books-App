...
public class ViewHolderMyBooks extends RecyclerView.ViewHolder {

    View mView;
    public RatingBar rtw;
    public ViewHolderMyBooks(@NonNull View itemView) {
        super(itemView);
    ...
    public void setDetails (Context ctx, String bookid, String bookname, String bookphoto, String pdflink
